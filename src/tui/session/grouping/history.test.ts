...
// (test/cli/tui/group-boundary.test.ts) — completeGroupBoundary re-homed from
// upstream rows.ts to our grouping/history.ts (slice-1 layout).
import { expect, test } from "bun:test"
import { completeGroupBoundary } from "./history"
