...
// (tui/routes/session/grouping/tree.ts, commit b6bc55764c) — the transcript
// grouping tree engine: adjacent entries grouped by configured nesting paths,
// seam-merging concatenation, depth-first splitting. No imports, no framework.
// Slice 1 of the transcript-render refactor family: model only, unwired.
