...
// (tui/routes/session/mount-budget.ts, commit b3b030856b #50936) — transcript
// mounting budgeted by rendered entries, not rows: a collapsed group renders
// one header however many parts it holds; expanded or ungrouped renders
// children. Slice 1 of the transcript-render refactor family: model only,
// unwired — the index-side budget wiring lands with the render rework.
