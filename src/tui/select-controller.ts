// Verbatim port of the reference ui/select-controller.ts (vendored at
// tools/opencode-reference/tui/ui/select-controller.ts, MIT) — the pure
// selection/window arithmetic behind the v2 dialog-select and footer-menu
// grammars. Selection wraps at the ends (policy "wrap" in the reference
// keymap layer); windows scroll with a reveal margin instead of the old
// center-slice heuristic.
